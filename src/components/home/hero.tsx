...
export function Hero() {
  return (
    <section className="relative isolate overflow-hidden bg-ink">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-32 right-[-15%] h-[32rem] w-[32rem] rounded-full bg-brand-orange/25 blur-[110px]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute bottom-[-20%] left-[-10%] h-[26rem] w-[26rem] rounded-full bg-white/[0.06] blur-[100px]"
      />
      <div
        aria-hidden="true"
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center px-6 pb-28 pt-40 text-center sm:pt-48 sm:pb-36 lg:px-8">
        ...
        <h1 className="opacity-0 [animation-delay:120ms] animate-fade-up mt-8 text-balance text-4xl font-semibold leading-[1.05] tracking-tight text-white sm:text-6xl lg:text-7xl">
          Learning that transforms potential into purpose.
        </h1>
